...
public class TreinoA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTexto5.setFont(new java.awt.Font("Arial", 0, 8)); // NOI18N
        lblTexto5.setForeground(new java.awt.Color(255, 255, 255));
        lblTexto5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTexto5.setText("DEITADO OU INCLINADO, TRICEPS APOIADO NO BANCO.");
        getContentPane().add(lblTexto5);
        lblTexto5.setBounds(330, 430, 300, 10);
        ...
        lblTexto1.setText("SUPINO RETO COM BARRA, SUPINO INCLINADO COM BARRA,");
        getContentPane().add(lblTexto1);
        lblTexto1.setBounds(360, 390, 250, 10);
        ...
        lblTexto2.setText("CRUCIFIXO, FLEXÃO DE BRAÇO BÁSICA, ELEVAÇÃO LATERAL, ");
        getContentPane().add(lblTexto2);
        lblTexto2.setBounds(360, 400, 250, 10);
        ...
        lblTexto3.setText("ELEVAÇÃO FRONTAL, TRICEPS NA MÁQUINA, SUPINO NO");
        getContentPane().add(lblTexto3);
        lblTexto3.setBounds(330, 410, 300, 10);
        ...
        lblTexto4.setText("BANCO RETO PEGADA FECHADA, EXTENSÃO DE TRICEPS ");
        getContentPane().add(lblTexto4);
        lblTexto4.setBounds(330, 420, 300, 10);
        ...
        lblInfo.setText("PEITO, OMBRO E TRÍCEPS.");
